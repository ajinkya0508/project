...
<body>
	...
	<div style="background-color: #FFE4E1;" class="container p-3">
		<p style="background-color: yellow;" class="text-center fs-2 ">Key Features of our smart trip planner</p>
					...
					<div class="col-md-6">
						...
						<div class="card paint-card">
							<div class="card bg-success text-white">
								<p class="fs-5"></p>
								<p>1.)Safety is a top priority for our trip planner, and we
					...
					<div class="col-md-6">
						...
						<div class="card paint-card">
							<div class="card bg-info text-white">
								<p class="fs-5"></p>
								<p>1.) At our trip planner, we understand the importance of
					...
					<div class="col-md-6 mt-2">
						...
						<div class="card paint-card">
							<div class="card bg-secondary text-white">
								<p class="fs-5"></p>
								<p>1)Our trip planner is committed to providing high-quality
