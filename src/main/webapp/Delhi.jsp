...
<body style="background-repeat: no-repeat; background-size: 100% 150%; background-image:url(image/banner1.jpg)">
    <div class="container">
        ...
        <div class="container">
        	<img src="image/delhi/hotel-3.jpeg" alt="Hotel Banner" class="banner-image">
        	<h1>The Lalit New Delhi</h1>
    ...
    <div class="container">
        	<img src="image/delhi/hotel-4.jpeg" alt="Hotel Banner" class="banner-image">
        	<h1>Novotel </h1>
